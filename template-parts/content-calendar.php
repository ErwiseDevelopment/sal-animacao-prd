                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php foreach ($array_meses as $mes => $meses): ?>
                                    <div class="swiper-slide">
                                        ...
                                        <h6 class="l-calendar__date u-font-weight-black text-center text-uppercase u-color-folk-theme">
                                            <!-- Agosto // 2021 -->
                        ...
                        ?>
                                    <div class="swiper-slide">
                                        ...
                                        <div class="col my-3 my-md-0">
                                            ...
                                            <h6 class="l-calendar__title u-font-weight-black text-uppercase u-color-folk-theme">
                                                destaques:
                                            </h6>
            ...
            <div class="col-12 mb-5 my-md-5">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 d-flex justify-content-center">
                        <a
                        class="l-calendar__btn hover:u-opacity-8 d-block d-md-inline-block u-font-weight-bold text-decoration-none u-color-folk-white u-bg-folk-theme mb-3 mb-md-0 py-3 px-4"

...
//video
const swiperVideo = new Swiper( '.js-swiper-video', {
    spaceBetween: 30,
    loop: true,
    ...
    navigation: {
        prevEl: '.js-swiper-button-prev-video',
        nextEl: '.js-swiper-button-next-video'
    }
})

//founder
const swiperFounder = new Swiper( '.js-swiper-founder', {
    allowTouchMove: false,
    
    navigation: {
        prevEl: '.js-swiper-button-prev-founder',
        nextEl: '.js-swiper-button-next-founder'
    }
})